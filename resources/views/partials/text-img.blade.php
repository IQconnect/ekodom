...
<section class="text-img @if ($site == 'prawo') text-img--rev @endif">
    <div class="container">
        <div class="row text-img__wrapper">
            <div class="col-12 col-md-12 col-lg-5 text-img__image-wrapper">
                <img class="text-img__image text-img__image--contain" src="{{ $image['url'] }}" alt="{{ $image['alt'] }}">
            </div>
            <div class="col-12 col-md-12 col-lg-6 text-img__content content-block content-block--equalline">
